          ...
          <div style={{ gridTemplateColumns: "repeat(auto-fit, minmax(350px, 1fr))" }} className="grid gap-4">
            ...
            <section className="rounded-lg bg-[#F8F9FF]  border border-zinc-300 shadow-sm">
              ...
              <div className="p-4 ">
                ...
                <p>بفضل تبرعاتكم، تمكنا من توزيع 5,000 وجبة غذائية
                  متكاملة للأطفال والعائلات المتضررة.</p>
              </div>
            </section>
            ...
            <section className="rounded-lg bg-[#F8F9FF]  border border-zinc-300 shadow-sm">
              ...
              <div className="p-4 ">
                ...
                <p>تأمين الأدوية والرعاية الصحية لـ 300 مريض يومياً من
                  خلال العيادات المجهزة بدعمكم.</p>
              </div>
            </section>
            ...
            <section className="rounded-lg bg-[#F8F9FF]  border border-zinc-300 shadow-sm">
              ...
              <div className="p-4 ">
                ...
                <p>توفير مياه شرب نظيفة ومستدامة لأكثر من 10 قرى نائية
                  كانت تعاني من الجفاف الحاد.</p>
              </div>
            </section>
