...
const DashboardAidOrders = () => {
    const [statusFilter, setStatusFilter] = useState<"all" | orderAidStatus>("all");

    return (
        <section className="flex flex-col gap-6">
            <DashboardAidOrdersHero statusFilter={statusFilter} setStatusFilter={setStatusFilter} />
            <DashboardAidOrdersTable statusFilter={statusFilter} setStatusFilter={setStatusFilter} />
