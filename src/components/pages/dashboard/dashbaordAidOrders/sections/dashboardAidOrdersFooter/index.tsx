    ...
    return (
        <section className="gap-6 min-h-40 grid" style={{gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))"}}>
            ...
            <article className="flex flex-col shrink gap-2 py-4 px-2 bg-white rounded-md border border-zinc-400">
                ...
                <p>يتم احتساب الأولوية بناءً على عوامل متعددة تشمل: الدخل
                    الحالي، عدد أفراد الأسرة، الحالة الصحية، وتاريخ استلام
                    المساعدات السابق لضمان التوزيع العادل والمستند إلى الحاجة الفعلية.</p>
                <div className="flex items-center gap-2">
                    <small className="text-primary font-medium">تعرف على معايير الحساب</small>
            ...
            <article className="rounded-md grow bg-white flex flex-col border border-zinc-400 justify-center gap-2 px-4 py-2">
                ...
                <p>يتم ربط الطلبات تلقائياً بالمخزون المتوفر في أقرب مركز توزيع للمستفيد.</p>
            </article>
