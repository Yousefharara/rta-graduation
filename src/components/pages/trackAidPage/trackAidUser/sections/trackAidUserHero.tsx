        ...
        <div className="flex gap-2 items-center">
          ...
          <div className="flex flex-col gap-1">
            <div className="flex gap-2 items-center">
              ...
              <small className="text-center rounded-full bg-muted px-3 py-0.5">جاري التجهيز</small>
            </div>
            <p>تاريخ إنشاء الطلب: 12 أكتوبر 2025</p>
          </div>
        </div>
        <div className="flex gap-3 ">
          <Button className="flex gap-3 items-center font-semibold" variant="outline">
            تعديل البيانات
            <Pencil />
          </Button>
